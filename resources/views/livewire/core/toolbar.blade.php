                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
                    ...
                    <div class="d-flex gap-4 gap-lg-13">
                        ...
                        <div class="d-flex flex-column">
                            <!--begin::Number-->
                            <span class="text-white fw-bold fs-3 mb-1">{{ \Vortechstudio\Helpers\Facades\Helpers::eur($argent) }}</span>
                            <!--end::Number-->
                            <!--begin::Section-->
                        ...
                        <div class="d-flex flex-column">
                            <!--begin::Number-->
                            <span class="text-white fw-bold fs-3 mb-1">{{ $tpoint }}</span>
                            <!--end::Number-->
                            <!--begin::Section-->
                        ...
                        <div class="d-flex flex-column">
                            <!--begin::Number-->
                            <span class="text-white fw-bold fs-3 mb-1">{{ \Vortechstudio\Helpers\Facades\Helpers::eur($research) }}</span>
                            <!--end::Number-->
                            <!--begin::Section-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            <span class="text-warning fs-2x fw-bold">Niveau {{ $level }}</span>
                            <div class="d-flex flex-column justify-content-center align-items-center">
                                <span class="text-white">{{ $xp }} EXP</span>
                                <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                    <div class="bg-white rounded h-8px" role="progressbar" style="width: {{ $xp_percent }}%;" aria-valuenow="{{ $xp_percent }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
