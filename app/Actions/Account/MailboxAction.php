...
class MailboxAction
{
     ...
     */
    public function addArgent(int $value): void
    {
     ...
     */
    public function addTpoint(int $value): void
    {
     ...
     */
    public function newMessage(User $user, string $subject, string $message, string $type = 'global', ?array $rewards = []): void
    {
